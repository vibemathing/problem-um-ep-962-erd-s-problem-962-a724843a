...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-962-erd-s-problem-962-a724843a-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-962"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-962-erd-s-problem-962-a724843a-v1",
      "problem_contract_sha256": "cf5dcad504e4fb9d6ef46fb80853569a04fbdc845b721a8a7a397c6ef6edba56",
      "problem_id": "problem:um-ep-962-erd-s-problem-962-a724843a",
      "route_id": "route:um-ep-962-erd-s-problem-962-a724843a-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-962-erd-s-problem-962-a724843a-source-fidelity-01",
      "graph_id": "graph:um-ep-962-erd-s-problem-962-a724843a-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-962-erd-s-problem-962-a724843a-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-962-erd-s-problem-962-a724843a-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $k(n)$ be the maximal $k$ such that there exists $m\\leq n$ such that each of the integers $ m+1,\\ldots,m+k $ are divisible by at least one prime $>k$. Estimate $k(n)$."
          },
          "statement_sha256": "a8bf567587e1614c26121917ee5cd34100e2c78bda2179364c463da53ffedce9"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-962-erd-s-problem-962-a724843a-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-962-erd-s-problem-962-a724843a-root",
      "route_id": "route:um-ep-962-erd-s-problem-962-a724843a-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-962-cebd14b30543",
        "url": "https://www.unsolvedmath.com/problems/EP-962"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
